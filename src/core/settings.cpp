...
qreal Settings::defaultWindowOpacity() const
{
    return 1.0;
}
...
bool Settings::defaultFpsVisible() const
{
    return false;
}
...
{
    SET_SHORTCUT("fullScreenShortcut", defaultFullScreenShortcut, fullScreenShortcutChanged)
}
